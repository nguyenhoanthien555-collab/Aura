...
1. Read this file.
2. Read .Codex/project-state.md.
3. Read .Codex/current-task.md.
4. Read .Codex/progress.md.
5. Read .Codex/decisions.md only when architectural decisions are relevant.
...
The repository and .Codex/*.md state files are the persistent source of truth.
...
2. Update .Codex/current-task.md.
3. Update .Codex/project-state.md if architecture/status changed.
4. Record important architectural decisions in .Codex/decisions.md.
...
### Before coding
1. Read `.Codex/project-state.md`.
2. Read `.Codex/current-task.md`.
...
5. Update `.Codex/progress.md`.
6. Update `.Codex/current-task.md`.
7. Update `.Codex/project-state.md` when architecture or project status changes.
...
- Read the persistent `.Codex/*.md` state files first.
- Inspect the current repository state.
- Continue from `current-task.md`.
- Do not redo completed work.
